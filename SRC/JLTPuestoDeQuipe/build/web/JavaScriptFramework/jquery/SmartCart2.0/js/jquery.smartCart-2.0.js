...
(function($){
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
                ...
                // Labels & Messages              
                var labelCartMenuName = 'Ordenes (_COUNT_)';  // _COUNT_ will be replaced with cart count
                var labelCartMenuNameTooltip = "Ordenes | Total Ordenes: _PRODUCTCOUNT_ | Total Cantidad: _ITEMCOUNT_";
                var labelProductMenuName = 'Products';
                var labelSearchButton = "Buscar";
                var labelSearchText = "Producto";
                ...
                var labelProducts = 'Producto';
                var labelPrice = 'Precio';
                var labelSubtotal = 'Subtotal';
                var labelTotal = 'Total';
                var labelRemove = 'Quitar';
                var labelCheckout = 'Continuar...';
                
                var messageConfirmRemove = 'Realmente quiere quitareste producto "_PRODUCTNAME_" de la orden ?'; //  _PRODUCTNAME_ will be replaced with actula product name
                var messageCartEmpty = "No hay Ordenes";
                var messageProductEmpty = "No hay Productos para mostrar";
                var messageProductAddError = "Producto no puede ser Agregado";
                var messageItemAdded = "Producto Agregado a la Orden";
                var messageItemRemoved = "Producto quitado de la Orden";
                var messageQuantityUpdated = "Cantidad Actulalizada";
                var messageQuantityErrorAdd = "Cantidad Invalida. Producto no puede agregarse";
                var messageQuantityErrorUpdate = "Cantidad Invalida. Cantidad no puede actualizarse";
