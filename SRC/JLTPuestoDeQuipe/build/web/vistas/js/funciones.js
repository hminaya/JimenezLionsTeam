...
function validaNun(evt){	
// NOTE: Backspace = 8, Enter = 13, '0' = 48, '9' = 57	
var key = nav4 ? evt.which : evt.keyCode;	
return (key <= 13 || (key >= 48 && key <= 57));
}

// valida solo numeros real o entero (no deja tipear algo no sea numero o punto)
function validaNunReal(evt, campo){	
// NOTE: Backspace = 8, Enter = 13, '0' = 48, '9' = 57	 '.' = 46
var dato = campo.value;
var pos = dato.indexOf('.'); // -1 si no encuentra el punto en la cadena otros numero si lo encuentra
var key = nav4 ? evt.which : evt.keyCode;	
return (key <= 13 || (key >= 48 && key <= 57) || (key == 46 && pos == -1));
}

// valida solo letras (no deja tipear algo no letra o espacio)
function validaSoloLetras(evt){	
// NOTE: Backspace = 8, Enter = 13, 'A' = 65, 'Z' = 90	 'a' = 97  'z' = 122 espacio = 32
var key = nav4 ? evt.which : evt.keyCode;	
...
function esAlphaNumerico(YourAlphaNumeric)
{
...
var monthArrayLong = new Array('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'Noviembre', 'December');
