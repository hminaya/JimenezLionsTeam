...
<form action="" method="get">
 ...
 <%
ArrayList<IEntidad> listaOrdenesHoy = (ArrayList) request.getAttribute("lista.ordenesDetalle");
...
<h1>
Codigo: <% out.print( ordenes.getOrdenID()); %>  <br/>
Nombre del Solicitante: <% out.print( ordenes.getNombreSolicitante()); %> <br/>
Email: <% out.print( ordenes.getCorreoElectronico()); %> <br/>
Telefono:<% out.print( ordenes.getTelefono()); %> <br/>
Celular: <% out.print( ordenes.getCelular()); %> <br/>
Direccion: <% out.print( ordenes.getDireccionDetallada()); %> <br/>
Fecha: <% out.print( ordenes.getFechaPedido()); %> <br/>
</h1>
...
%>
		<h1>Detalle de la Orden</h1>
                <iframe src="ServletControlOrdenesDetalles?accion=listadoDetalle&ordenid=<%=request.getParameter("ordenid") %>" width="80%" height="200" id='frameDemo'></iframe>
...
<br/>
     ...
     <a href="ServletControlOrdenes?accion=ConfirmarOrden&ordenid=<%=request.getParameter("ordenid") %>" onclick="javascript:window.print();" >Procesar Orden</a>
