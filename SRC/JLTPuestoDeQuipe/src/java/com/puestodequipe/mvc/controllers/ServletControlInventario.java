...
import com.puestodequipe.mvc.database.DAOEntidadInventario;
 ...
 * @author developer
 */
public class ServletControlInventario extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(accion == null || accion.isEmpty()){
                    ...
                    DAOEntidadInventario daoinventario = new DAOEntidadInventario();

                    ArrayList listainventario = daoinventario.listar(null); // si es null no se aplica el Where en la clausula select del metodo listar;
                    request.setAttribute("lista.inventario",listainventario );
